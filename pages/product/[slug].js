...
const ProductDetails = ({ product, products }) => {
  ...
  console.log(p.categories.data[0].attributes.name);
          ...
          <div className="flex-[1] py-3">
            ...
            <div className="mb-10">
              ...
              <div className="flex justify-between mb-2">
                ...
                <div
                  className={`${
                    hover
                      ? "font-bold text-xl text-red-700"
                      : "text-md text-black/[0.5] font-medium"
                  } cursor-pointer`}
                  onClick={() => setHover(!hover)}
                >
                  {!hover ? "Select Guide" : "X"}
                  {/* 3, 14 */}
                  <div className="absolute z-[20] top-[42rem] right-[2.6rem] md:top-[42rem] md:right-[7.3rem] shadow-lg w-[200px] md:w-[400px] lg:top-[3rem] lg:right-[7rem] xl:right-[14rem] 2xl:right-[47rem]">
                    {hover &&
            ...
            <div>
              ...
              <div className="markdown text-md mb-5">
                {console.log("Product Description Object:", p.description)}
                {p.description.map((content, index) => {
                  switch (content.type) {
                    case "heading":
                      return <h4 key={index}>{content.children[0].text}</h4>;
                    case "list":
                      return (
                        <ul key={index}>
